...
interface ApplilanceProps {
  searchParams: IProductParams;
}

const breadcrumbItems = [
  { label: " Inicio ", link: "/" },
  { label: " Electrodomésticos ", link: "/electrodomesticos" },
];

async function Applilance({ searchParams }: ApplilanceProps) {
  ...
  const Products = products.filter(
    (product) => product.category === "Electrodomésticos"
  );
